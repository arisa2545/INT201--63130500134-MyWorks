...
// splice() เป็น method ที่เอาไว้จัดการกับข้อมูลภายใน array ทั้งการ insert replace delete ตามการใช้ syntax ในเเต่ละเเบบ
// มีทั้งหมด 4 syntax


// splice(start) ------------------------------------
// start คือการะบุ index เริ่มตั้นที่จะทำการเปลี่ยนเเปลง (insert, replace, delete)
// ซึ่งการใช้ syntax ที่ parameter มีแค่ (start) หมายถึงการให้ลบข้อมูลทั้งหมดตั้งเเต่ start เป็นต้นไป
...
// ถ้าหากว่าเราระบุ start เกินกว่า index ใน array ก็จะไม่มีการ delete element ใดๆเกิดขึ้นใน array นั้น
course.splice(6);
...
// delete 2 element โดยเริ่มจาก index ที่ 3
days.splice(3,2);
 
console.log(`days.splice(3,2) --------`);
console.log(days);
...
// ** ในกรณีที่เราใส่ deleteCount น้อยกว่าจำนวน item ที่ใส่เข้ามา
